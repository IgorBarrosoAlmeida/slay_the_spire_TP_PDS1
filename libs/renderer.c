...
void RenderBackground(Renderer_t* renderer)
{
    al_clear_to_color(al_map_rgb(0, 0, 0));
}

void RenderDeck(Renderer_t* renderer, int x_left, int y_top)
{
...
void RenderCreature(const Renderer_t* renderer, int begin_x, int mid_y,
    int width)
{
...
void RenderCard(const Renderer_t* renderer, int x_left, int y_top)
{
...
void RenderPlayerHand(Renderer_t* renderer)
{
    RenderCard(renderer, HAND_BEGIN_X, HAND_BEGIN_Y);
}

void RenderEnemies(Renderer_t* renderer) { }

void RenderEnergy(Renderer_t* renderer) { }
...
void ClearRenderer(Renderer_t* renderer)
{
